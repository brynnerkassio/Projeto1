...
<body>
	...
	<form action="/Druida/processoDespesa" method="get">
		<fieldset>
			<legend>Listar Processos por Despesas</legend>
			<p>
		...
		<tbody>
			<!--<c:forEach items="${requestScope.lista}" var="li">-->
				<tr>
					...
					<td colspan="2"><a href="lancarDespesaSetup?nroProcesso=${li.nroProcesso}">Lançar Despesa</a> - <a href="listarDespesa?nroProcesso=${li.nroProcesso}">Consultar Despesa</a></td>
				</tr>
			<!--</c:forEach>-->
		</tbody>
	</table>
