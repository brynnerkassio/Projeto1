...
import br.com.fiap.am.druida.bo.ProcessoHonorarioBO;

@WebServlet("/processoHonorario")
public class ProcessoHonorario extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		ProcessoHonorarioBO pHBO = new ProcessoHonorarioBO();
		...
		try {
			...
			if (controleIf == 1)
				lista = pHBO.recuperarProcPorNro(objP);
			else if (controleIf == 2)
				lista = pHBO.recuperarProcPorCliente(objC);
			else if (controleIf == 3)
				lista = pHBO.recuperarProcPorPeriodo(objD);
		...
		request.getRequestDispatcher("listar/processo/honorario/resultado.jsp")
